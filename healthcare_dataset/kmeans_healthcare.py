...
# ── 1. 讀取資料 ──────────────────────────────────────────────────────────────
CSV_PATH = Path(r"c:\Users\jack6\OneDrive\Desktop\data\healthcare_dataset.csv\healthcare_dataset.csv")
...
# ── 6. 結果儲存 ───────────────────────────────────────────────────────────────
output_csv = Path(r"c:\Users\jack6\OneDrive\Desktop\data\kmeans_results.csv")
...
plt.tight_layout()
output_png = Path(r"c:\Users\jack6\OneDrive\Desktop\data\kmeans_healthcare.png")
